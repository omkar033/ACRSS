					...
					<form action="" id="booking-form">
						...
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<input type="text" name="contact" id="contact" required="required"  pattern="[0-9]{10}" title="Enter a 10-digit phone number"class="form-control form-control-sm rounded-0" value="<?php echo isset($contact) ? $contact : ''; ?>"  required/>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
